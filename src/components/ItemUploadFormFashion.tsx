...
function ItemUploadFormFashion({ aiAssistEnabled = false, aiSuggestions = {} }: ItemUploadFormFashionProps) {
  ...
  // Use Fashion-specific categories from centralized data
  const fashionCategories = categoriesByVertical.Fashion
