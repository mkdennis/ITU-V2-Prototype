...
export function findMatchingCategory(input: string): Category | null {
  ...
  const categoryKeywords: Record<string, { l1: string; l2: string }> = {
    // Tables
    'coffee table': { l1: 'Tables', l2: 'Coffee Tables' },
    'dining table': { l1: 'Tables', l2: 'Dining Tables' },
    'side table': { l1: 'Tables', l2: 'Side Tables' },
    'end table': { l1: 'Tables', l2: 'Side Tables' },
    'console': { l1: 'Tables', l2: 'Console Tables' },
    ...
    'dresser': { l1: 'Case Pieces and Storage Cabinets', l2: 'Dressers and Chests of Drawers' },
    'chest of drawers': { l1: 'Case Pieces and Storage Cabinets', l2: 'Dressers and Chests of Drawers' },
    // More Furniture and Collectibles
    'bed': { l1: 'More Furniture and Collectibles', l2: 'Beds' },
    'headboard': { l1: 'More Furniture and Collectibles', l2: 'Beds' },
    // Seating
    'sofa': { l1: 'Seating', l2: 'Sofas' },
    'couch': { l1: 'Seating', l2: 'Sofas' },
    'sectional': { l1: 'Seating', l2: 'Sectional Sofas' },
    'sectional sofa': { l1: 'Seating', l2: 'Sectional Sofas' },
    'loveseat': { l1: 'Seating', l2: 'Loveseats' },
    'armchair': { l1: 'Seating', l2: 'Armchairs' },
    'lounge chair': { l1: 'Seating', l2: 'Lounge Chairs' },
    'club chair': { l1: 'Seating', l2: 'Club Chairs' },
    'dining chair': { l1: 'Seating', l2: 'Dining Chairs' },
    'side chair': { l1: 'Seating', l2: 'Side Chairs' },
    'stool': { l1: 'Seating', l2: 'Stools' },
    'bar stool': { l1: 'Seating', l2: 'Stools' },
    'bench': { l1: 'Seating', l2: 'Benches' },
    'ottoman': { l1: 'Seating', l2: 'Ottomans and Poufs' },
    'pouf': { l1: 'Seating', l2: 'Ottomans and Poufs' },
    'bergere': { l1: 'Seating', l2: 'Bergere Chairs' },
    'canape': { l1: 'Seating', l2: 'Canapes' },
    'chaise': { l1: 'Seating', l2: 'Chaise Longues' },
    'chaise longue': { l1: 'Seating', l2: 'Chaise Longues' },
    'corner chair': { l1: 'Seating', l2: 'Corner Chairs' },
    'daybed': { l1: 'Seating', l2: 'Daybeds' },
    'footstool': { l1: 'Seating', l2: 'Footstools' },
    'office chair': { l1: 'Seating', l2: 'Office Chairs and Desk Chairs' },
    'desk chair': { l1: 'Seating', l2: 'Office Chairs and Desk Chairs' },
    'rocking chair': { l1: 'Seating', l2: 'Rocking Chairs' },
    'rocker': { l1: 'Seating', l2: 'Rocking Chairs' },
    'settee': { l1: 'Seating', l2: 'Settees' },
    'slipper chair': { l1: 'Seating', l2: 'Slipper Chairs' },
    'swivel chair': { l1: 'Seating', l2: 'Swivel Chairs' },
    'windsor chair': { l1: 'Seating', l2: 'Windsor Chairs' },
    'wingback': { l1: 'Seating', l2: 'Wingback Chairs' },
    'wingback chair': { l1: 'Seating', l2: 'Wingback Chairs' },
